...
public class Main1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000000; i++){
            linkedList.add(i,"uhtr" + i);
        }
        long endTimeLinkAdd = System.currentTimeMillis();
        System.out.println("Linked add:" + (endTimeLinkAdd-startTimeLinkAdd));
        ...
        System.out.println("Linked get:" + (endTimeLinkGet-startTimeLinkGet));
